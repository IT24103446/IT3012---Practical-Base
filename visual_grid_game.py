...
class VisualGridHuntGame:
    ...
    def __init__(self, width=10, height=10, num_food=10, num_opponents=2, custom_walls=None,
        ...
        # Toxic traps are environmental hazards. They never replace the start,
        # a wall, food, or an opponent, so every object remains visible and usable.
        ...
        trap_count = min(num_toxic_traps, len(available_trap_positions))
        self.toxic_traps = set(random.sample(available_trap_positions, trap_count))
...
class GridGameGUI:
    ...
    def draw_grid(self):
        ...
        # Purple triangles distinguish toxic traps from food and opponents.
